...
switch ($Command) {
    ...
    "voice" {
        ...
        if ($local) {
            ...
            $voiceWebhookUrl = "$webhookUrl$apiV1Str/telephony/voice"
            $eventsWebhookUrl = "$webhookUrl$apiV1Str/telephony/events"
            $dtmfWebhookUrl = "$webhookUrl$apiV1Str/telephony/dtmf"
